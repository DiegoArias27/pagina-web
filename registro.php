...
<div class="overlay" id="overlay"></div>
    ...
    <div class="mar">
        <div class="reg">
            <div class="no-limpio">
                <h2>¿Cansado de perder el tiempo?</h2>
                <img src="registro-usu.png" alt="">
            </div>
            <div class="form-registro">
                <h2>¡Haz tu registro!</h2>
                <form action="reg.php" enctype="multipart/form-data" method="post"  onsubmit="return validarContra()">
