...
if (isset($_FILES['foto']) && $_FILES['foto']['error'] === UPLOAD_ERR_OK) {
    ...
    $sql = "INSERT INTO usuario (Nombre, ApellidoP, ApellidoM, Correo, Contraseña, Genero, Telefono, Fechanac, Calle, exterior, interior, CodigoP, Colonia, Fotografia) VALUES ('$nombre', '$paterno', '$materno', '$correo', '$contraseña', '$genero', '$telefono', '$fecha_nacimiento', '$calle', '$exterior', '$interior', '$codigo_postal', '$colonia', '$imagen_contenido')";
